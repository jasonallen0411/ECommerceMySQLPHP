...
?>
            ...
            <div class="card col-md-3 mt-4">
                ...
                <div class="card-body">
                    ...
                    <p class="list-price text-danger">List Price: <s>$<?= $product['price']; ?></s></p>
                    <p class="price">Our Price: $<?= $product['list_price']; ?></p>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#<?php echo "detailsView" . $product['id'] ?>">
                        Details
                    </button>
                    <!-- <button type="button" class="btn btn-success" data-toggle="modal" data-target="#details-1">Details</button> -->
                </div>
            ...
            <!-- Modal -->
                <div class="modal fade" id="<?php echo "detailsView" . $product['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo "detailsView" . $product['id'] ?>" aria-hidden="true">
